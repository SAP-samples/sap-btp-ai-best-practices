...
# Create FastAPI app
app = FastAPI(
    title="Evaluation Assessment Assistant",
    description="FastAPI server for assessment document management and AI review",
    version="1.0.0",
)
...
try:
    ...
    logger.warning(
        "a2a-sdk is not installed; Assessment knowledge A2A endpoint is disabled."
    )
