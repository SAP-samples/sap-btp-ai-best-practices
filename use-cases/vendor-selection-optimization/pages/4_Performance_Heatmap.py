...
def main() -> None:
    ...
    if selected_maktx == "All":
        st.info("Please select a Material Description from the sidebar to view the heatmap.")
        return
    ...
    components.display_page_intro("Performance Heatmap", df_filtered)
    components.render_heatmap_tab_standalone(df_filtered)
