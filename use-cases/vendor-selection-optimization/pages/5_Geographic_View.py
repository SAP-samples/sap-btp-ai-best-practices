...
def main() -> None:
    ...
    if selected_maktx == "All":
        st.info("Please select a Material Description from the sidebar to view geographic insights.")
        return
    ...
    components.display_page_intro("Geographic View", df_filtered)
    components.render_geographic_tab_standalone(df_filtered)
