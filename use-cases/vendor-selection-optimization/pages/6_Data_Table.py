...
def main() -> None:
    ...
    if selected_maktx == "All":
        st.info("Please select a Material Description from the sidebar to view the data table.")
        return
    ...
    components.display_page_intro("Data Table", df_filtered)
    components.render_data_table_tab_standalone(df_filtered)
