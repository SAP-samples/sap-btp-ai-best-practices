...
PDF pages to images and also extracts text using pdfplumber. Both the
...
class SimpleImageExtractor:
    ...
    This class provides a direct path from PDF to answer.
    """
    ...
    def _pdf_to_images(
        ...
        try:
            ...
            logger.error(f"Error opening or processing PDF document: {e}")
            ...
            with pdfplumber.open(pdf_path) as pdf:
                ...
                for page_num in range(pages_to_process):
                    try:
                        ...
                        logger.debug(f"Extracted {len(text or '')} characters from page {page_num + 1}")
                    except Exception as e:
