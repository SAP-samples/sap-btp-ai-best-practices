...
from routers import credit_policy
from routers import credit_report
...
app.include_router(credit_policy.router, prefix="/api/credit", tags=["credit"])
app.include_router(credit_report.router, prefix="/api/credit", tags=["credit"])
