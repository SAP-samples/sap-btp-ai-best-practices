...
from .routers import grounding, contracts, contract_analysis
...
app.include_router(contracts.router, prefix="/api/storage", tags=["contracts"])
app.include_router(
    contract_analysis.router,
    prefix="/api/contract-analysis",
