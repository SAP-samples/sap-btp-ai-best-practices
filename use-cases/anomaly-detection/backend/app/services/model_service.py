    ...
    def load_models(self, results_dir: str = None) -> bool:
        ...
        try:
            if results_dir is None:
                ...
                if not results_dir:
                    logger.error("No suitable model directories found")
                    return False
            ...
            logger.error("No compatible models found in the results directory")
            return False
    ...
    def compute_shap_for_sample(self, sample_row: pd.Series, features_df: pd.DataFrame = None) -> Optional[str]:
        ...
        try:
            ...
            if not available_features:
                logger.error("No overlapping features between model and dataset for SHAP computation")
                return None
            ...
            if model_to_use is None:
                logger.error("Model not available for SHAP computation")
                return None
