...
def create_tqdcs_spider_chart(
    ...
    for cat in ['technology', 'quality', 'delivery', 'cost', 'sustainability']:
    ...
    fig.update_layout(
        ...
        showlegend=True,
        title="TQDCS Performance Comparison",
        height=500
    )
...
def display_certification_badges(
    ...
    for i, cert in enumerate(certifications[:max_display]):
        with cols[i]:
            ...
            elif "PurchasingOrganization" in standard or "CVS" in standard:
                color = '#FF9800'  # Orange for PurchasingOrganization/CVS
            else:
