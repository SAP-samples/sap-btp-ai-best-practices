...
from .routers import example_router, chat, grounding, kg, analysis
...
app.include_router(chat.router, prefix="/api", tags=["chat"])  # exposes /api/v1/chat/*
app.include_router(grounding.router, prefix="/api/grounding", tags=["grounding"])
app.include_router(kg.router, prefix="/api", tags=["kg"])  # exposes /api/v1/kg/*
app.include_router(analysis.router, prefix="/api", tags=["analysis"])  # exposes /api/v1/analyze/*
