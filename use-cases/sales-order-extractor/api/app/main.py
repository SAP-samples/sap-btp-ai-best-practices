...
from .routers import pdf_extraction, excel_extraction, sales_order

# from .routers import chat  # Comentado temporalmente para evitar error de AI Core
...
# Include routers
app.include_router(pdf_extraction.router, prefix="/api/pdf", tags=["pdf-extraction"])
app.include_router(
    excel_extraction.router, prefix="/api/excel", tags=["excel-extraction"]
)
app.include_router(sales_order.router, prefix="/api/sales-order", tags=["sales-order"])
