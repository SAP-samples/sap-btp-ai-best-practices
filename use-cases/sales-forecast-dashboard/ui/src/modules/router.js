...
class PageRouter {
  ...
  async registerRoutes() {
    try {
      // Register root route to dashboard
      router("/", () => this.loadPage("dashboard"));
      ...
      // Fallback to a basic dashboard route
      router("/", () => this.loadPage("dashboard"));
    }
  }
  ...
  async show404() {
    ...
    this.contentContainer.innerHTML = `
      <div style="padding: 2rem; text-align: center;">
        ...
        <ui5-button style="margin-top: 1rem;" onclick="pageRouter.navigate('/dashboard')">
          Go to Dashboard
        </ui5-button>
      </div>
    `;
