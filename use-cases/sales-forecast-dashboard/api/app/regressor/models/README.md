...
This module contains the core prediction models for the Bob's sales forecasting system. It implements a dual-model, dual-channel architecture using CatBoost gradient boosting with multi-target regression.
