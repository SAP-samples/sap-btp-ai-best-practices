...
def add_generate_parser(subparsers):
    ...
    parser.add_argument(
        "--use-written-sales-for-web",
        action="store_true",
        help="Use Written Sales data for WEB sales instead of Ecomm Traffic",
    )
    return parser
...
def cmd_generate(args):
    ...
    print(f"  WEB sales source: {'Written Sales' if args.use_written_sales_for_web else 'Ecomm Traffic'}")
    ...
    if args.model == "both":
        ...
        df_b = build_canonical_training_table(
            ...
            use_written_sales_for_web=args.use_written_sales_for_web,
        )
