...
This module provides SHAP-based model interpretation utilities for Bob's Sales Forecasting System. The explainability layer is a critical component that enables business stakeholders to understand which operational levers and contextual factors drive forecast predictions across different stores, channels, and time horizons.
