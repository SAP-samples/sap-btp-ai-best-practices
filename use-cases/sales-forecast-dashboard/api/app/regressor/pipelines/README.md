...
This folder contains the orchestration pipelines for the Bob's sales forecasting system. These pipelines coordinate the end-to-end workflow from raw feature data to production predictions with explainability insights.
