...
**Location:** `/Users/I760054/Documents/programs/Bob_sales/forecasting/regressor/features/`

**Purpose:** Feature engineering primitives for Bob's sales forecasting system. This module implements a dual-architecture approach with Model A (actionable/explainability) and Model B (production/full accuracy).
