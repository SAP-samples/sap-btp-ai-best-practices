...
from .routers import accounts, answers, batch, chat
...
# Create FastAPI app
app = FastAPI(
    title="Customer Offer Advisor",
    description="API server for customer offer recommendations and LangGraph chat orchestration.",
    version="2.0.0",
)
...
@app.get("/")
def read_root():
    return {"message": "Welcome to the Customer Offer Advisor backend."}
