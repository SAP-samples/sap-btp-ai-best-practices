...
export default function initChatPage() {
  ...
  if (qa1) qa1.addEventListener("click", () => quickAsk("List the available tools and briefly describe how to use each."));
  if (qa2) qa2.addEventListener("click", () => quickAsk("Calculate (15 - 3) * (4 + 2) / 3 using the calculator tool."));
  if (qa3) qa3.addEventListener("click", () => quickAsk("List POs for BP1000001"));
  if (qa4) qa4.addEventListener("click", () => quickAsk("Show invoice 5100000001"));
  if (qa5) qa5.addEventListener("click", () => quickAsk("Show invoice 5100000001 and sum the items' amount"));
