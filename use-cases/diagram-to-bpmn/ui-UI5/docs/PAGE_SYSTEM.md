...
1. **Router**: Uses **page.js** for client-side routing with proper URL paths (e.g., `/home`, `/process-monitor`)
...
export const routes = [
  ...
  "process-monitor", // Creates route: /process-monitor
...
export const routes = [
  ...
  "process-monitor", // Automatically creates /process-monitor route
...
- **Page-specific components**: Import in the respective page's JS file
  - Generation components → `home/home.js`
  - Analytics components → `analytics/analytics.js`
...
/* pages/analytics/analytics.js - Analytics-specific components */
