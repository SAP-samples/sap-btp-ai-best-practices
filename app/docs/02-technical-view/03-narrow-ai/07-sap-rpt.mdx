    ...
    <div className="col col--4">
      <ul className="resource-links">
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/sap-rpt/pdfs/BTP AI Best Practices - Access to SAP RPT-1 model.pdf")}>
...
<img src={useBaseUrl("narrow-ai/sap-rpt/images/Access to Generative RPT-1 Model.png")} alt="High-level Reference Architecture for SAP RPT-1" />
...
<ul className="button-grid">
  <IconLinkButton href="/docs/technical-view/generative-ai/direct-model-access" text="Access to Generative AI Models" />
