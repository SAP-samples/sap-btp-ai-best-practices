    ...
    <div className="col col--4">
      <ul className="resource-links">
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/rpt-1/pdfs/BTP AI Best Practices - Access to SAP RPT-1 model.pdf")}>
...
<img src={useBaseUrl("narrow-ai/rpt-1/images/Access to Generative RPT-1 Model.png")} alt="High-level Reference Architecture for SAP RPT-1" />
