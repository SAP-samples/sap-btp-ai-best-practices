  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("predictive-ai/regression/videos/BTP AI Best Practices - Regression (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/regression/videos/BTP AI Best Practices - Predictive AI - Regression.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/regression/pdfs/BTP AI Best Practices - Predictive AI - Regression.pdf")}>
...
![High-level Reference Architecture](@site/static/predictive-ai/regression/images/scenarios.png)
...
![High-level Reference Architecture](@site/static/predictive-ai/regression/images/graph.png)
...
![High-level Reference Architecture](@site/static/predictive-ai/regression/images/arch.png)
...
For a comprehensive guide on the methodologies and best practices for discovering anomalies in your data, please refer to our unified [Anomaly Detection Best Practices page](/docs/technical-view/predictive-ai/anomaly-detection).
