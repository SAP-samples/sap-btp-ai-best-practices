  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("predictive-ai/clustering/videos/BTP AI Best Practices - Clustering (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/clustering/videos/BTP AI Best Practices - Predictive AI - Clustering.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/clustering/pdfs/BTP AI Best Practices - Predictive AI - Clustering.pdf")}>
...
![Clustering - High-level Reference Architecture](@site/static/predictive-ai/clustering/images/arch.png)
