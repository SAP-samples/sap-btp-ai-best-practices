---
title: Predictive AI
description: "Predictive AI is a specialized artificial intelligence designed to efficiently perform a specific task or a limited range of tasks. Unlike general AI, it cannot generalize its knowledge or skills to tasks beyond its designated domain."
...
<div className="section-with-background blue">
  <h2>What is Predictive AI?</h2>
  <p>
    Predictive AI is a specialized artificial intelligence designed to efficiently perform a specific task or a limited range of tasks. Unlike general AI, it cannot generalize its
...
<div className="row">
  ...
  <div className="col col--6">
    <h3>More</h3>
    <ul className="button-list">
      <IconLinkButton href="/docs/technical-view/predictive-ai/data-preparation-and-model-evaluation" text="Data Preparation and Model Evaluation" />
