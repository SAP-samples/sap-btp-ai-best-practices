...
![Confusion Matrix Example](@site/static/predictive-ai/data-preparation-and-model-evaluation/images/confusion-matrix-code.png)
...
![Confusion Matrix Example](@site/static/predictive-ai/data-preparation-and-model-evaluation/images/output-tables.png)

**Plotted Confusion Matrix:** Visualizing the matrix helps in quickly identifying the model's performance.

![Confusion Matrix Example](@site/static/predictive-ai/data-preparation-and-model-evaluation/images/plotted-confusion-matrix.png)
