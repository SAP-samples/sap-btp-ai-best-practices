...
description: "Train and deploy custom AI models within SAP BTP to augment existing capabilities and integrate tailored AI solutions into business processes."
hide_title: true
---
  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("predictive-ai/training-deployment-custom-ai-models/videos/BTP AI Best Practices - Training and deployment of custom models (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/training-deployment-custom-ai-models/videos/BTP AI Best Practices - Training and deployment of custom AI Models.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("predictive-ai/training-deployment-custom-ai-models/pdfs/BTP AI Best Practices - Training and deployment of custom AI Models.pdf")}>
...
![High-level Reference Architecture](@site/static/predictive-ai/training-deployment-custom-ai-models/images/arch.png)
...
4. Build your custom AI model in a container-ready environment: You can build your custom AI model as per your requirement using classical machine learning models, neural networks, or lightweight LLMs as well. Below are some of the references for your model development.  
   a. [Build a House Price Predictor Model](https://developers.sap.com/tutorials/ai-core-code.html): Based on your use case, you can leverage [best practice content](/docs/technical-view/predictive-ai) to build your Custom AI models.  
   b. Yoga Pose Image Classification: Use [training](https://github.com/amanichopra/sap-aicore-train/tree/main) and [inference](https://github.com/amanichopra/model-serving-aicore) pipeline to create a classifier for yoga pose images.  
   c. [Utilizing GPUs in SAP AI Core](https://developers.sap.com/tutorials/ai-core-tensorflow-byod.html): If your business application requires image processing, audio/video processing, or large computation, GPU provide a significant boost in processing time (both training and inference). You can leverage AI core instances with GPU support to leverage the same.  
