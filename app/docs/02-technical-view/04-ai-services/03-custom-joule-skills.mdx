...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Get_sales_order_item_details_by_sales_order.mp4')}
/>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Reads_all_sales_order_headers.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Create_a_sales_order.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Creates_a_sales_order_item_for_a_sales_order.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Initiate_approval_for_sales_order_request.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Download_top_sales_order_details.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Translate_the_text_to_another_language.mp4')}
/>
</details>
...
<video
  controls
  style={{width: '100%'}}
  src={useBaseUrl('/ai-services/custom-joule-skills/videos/Summarize_the_text_within_a_defined_word_limit.mp4')}
/>
</details>
