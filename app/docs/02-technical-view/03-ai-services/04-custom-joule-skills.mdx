  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("ai-services/custom-joule-skills/videos/BTP AI Best Practices - Custom Joule Skills (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("ai-services/custom-joule-skills/videos/BTP AI Best Practices - Custom Joule Skills.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("ai-services/custom-joule-skills/pdfs/BTP AI Best Practices - Custom Joule Skills.pdf")}>
...
2. Joule input and output parameters are configured as per below:
![Step 2-1](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/2.png)
![Step 2-1](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/3.png)
3. Create a destination variable as type ‘destination’ as shown below:
![Step 3](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/4.png)
4. Bind the input parameters of the action component as shown below:
![Step 4](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/5.png)
5. Bind the Joule skill outputs (‘End’ step) to the action component output as shown below:
![Step 5](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/6.png)
...
![Step 6](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/7.png)
7. Joule input and output parameters are configured as per below:
![Step 7-1](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/8.png)
![Step 7-2](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/9.png)
8. Add the first Joule skill to get the BCP language code of the target language as shown below:
![Step 8](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/10.png)
9. Bind the input parameters of the action component as shown below:
![Step 9](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/11.png)
10. Create a destination variable as type ‘destination’ as shown below:
![Step 10](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/12.png)
11. Bind the input parameters of the action component as shown below:
![Step 11](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/13.png)
12. A dd ‘Send Message’ step to Joule skill flow branch and specify the message for automation trigger as shown below:
![Step 12](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/14.png)
13. Bind the Joule skill outputs (‘End’ step) to the action component output as shown below:
![Step 13](@site/static/ai-services/custom-joule-skills/images/translate-text-through-joule-using-sap-translation-hub/15.png)
