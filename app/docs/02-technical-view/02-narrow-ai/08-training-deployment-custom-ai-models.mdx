  ...
  <div className="row">
    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <Link target="_blank" to={useBaseUrl("narrow-ai/training-deployment-custom-ai-models/videos/BTP AI Best Practices - Training and deployment of custom models (intro)_external.mp4")}>
            <Icon name="video" />
            <span>Teaser</span>
          </Link>
        </li>
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/training-deployment-custom-ai-models/videos/BTP AI Best Practices - Training and deployment of custom AI Models.mp4")}>
              <Icon name="video" />
              <span>Webinar</span>
            </Link>
          </li>
          <li>
            <Link target="_blank" to={useBaseUrl("narrow-ai/training-deployment-custom-ai-models/pdfs/BTP AI Best Practices - Training and deployment of custom AI Models.pdf")}>
...
4. Build your custom AI model in a container-ready environment: You can build your custom AI model as per your requirement using classical machine learning models, neural networks, or lightweight LLMs as well. Below are some of the references for your model development.  
   a. [Build a House Price Predictor Model](https://developers.sap.com/tutorials/ai-core-code.html): Based on your use case, you can leverage [best practice content](/docs/technical-view/narrow-ai) to build your Custom AI models.  
