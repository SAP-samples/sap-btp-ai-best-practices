    ...
    <div className="col col--4">
      <ul className="resource-links">
        <li>
          <a
            target="_blank"
            href={useBaseUrl("agentic-ai/joule-agent-builder/videos/BTP%20AI%20Best%20Practices%20-%20Content-based_Agents%20(intro)_external.mp4")}
          >
            <Icon name="video" />
            <span>Teaser</span>
          </a>
        ...
        <LoginWall renderOnlyWhenLoggedIn={true}>
          <li>
            <a
              target="_blank"
              href={useBaseUrl("agentic-ai/joule-agent-builder/videos/BP19_Content-based_Agents_with_SAP_Joule_Studio_Agent_Builder-compressed.mp4")}
            >
              <Icon name="video" />
              <span>Webinar</span>
            </a>
          ...
          <li>
            <a
              target="_blank"
              href={useBaseUrl("agentic-ai/joule-agent-builder/pdfs/BTP%20AI%20Best%20Practices%20-%20Content-based%20Agents.pdf")}
            >
