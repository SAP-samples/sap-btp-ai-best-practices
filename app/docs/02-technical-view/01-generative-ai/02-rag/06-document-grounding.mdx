...
<LoginWall renderOnlyWhenLoggedIn={true}>
  <TrackableLink href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/document-grounding/python" className="button button--primary button--lg download-source-btn" target="_blank" trackingFeature="">
...
- AWS S3 (available through Object Store on SAP BTP):  Follow the [link](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/document-grounding/python) to connect with S3 source
- SharePoint: Follow the [link](/docs/technical-view/ai-services/document-grounding-sharepoint) to know about the steps on how to enable SharePoint source
- SAP Document Management Service: Follow the [link](/docs/technical-view/ai-services/document-grounding-dms) to know about the steps to connect with SAP DMS
- SAP Work Zone: Follow the [link](/docs/technical-view/ai-services/document-grounding-workzone) to connect with SFTP file server
- SFTP File Server: Follow the [link](/docs/technical-view/ai-services/document-grounding-sftp) to know the steps to enable SFTP File Server

Additionally, you can use Vector API to ingest chunks, and metadata directly into the grounding service pipeline. Follow the [link](https://github.com/SAP-samples/sap-btp-ai-best-practices/blob/main/best-practices/generative-ai/document-grounding/python/Document_Grounding_Vector_API.ipynb) to know the steps to process your source data.
<br/>
...
<TrackableLink href="https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/document-grounding/python" className="button button--primary button--lg download-source-btn--tab" target="_blank" trackingFeature="">
  <span>Download Source Code</span>
</TrackableLink>
...
- To perform RAG using Document Grounding service you can refer the curated [Best Practice notebooks](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/document-grounding) for various document sources.
...
[SAP BTP AI Best Practices - Python Sample Code (End-to-End Document Grounding With Various Data Sources)](https://github.com/SAP-samples/sap-btp-ai-best-practices/tree/main/best-practices/generative-ai/document-grounding/python)
- S3:
  - Using SDK - [Document_Grounding_S3_SDK.ipynb](https://github.com/SAP-samples/sap-btp-ai-best-practices/blob/main/best-practices/generative-ai/document-grounding/python/Document_Grounding_S3_SDK.ipynb)
  - Using API - [Document_Grounding_S3_API.ipynb](https://github.com/SAP-samples/sap-btp-ai-best-practices/blob/main/best-practices/generative-ai/document-grounding/python/Document_Grounding_S3_API.ipynb)
- Direct Vector Data Ingestion:
  - Using Vector API - [Document_Grounding_Vector_API.ipynb](https://github.com/SAP-samples/sap-btp-ai-best-practices/blob/main/best-practices/generative-ai/document-grounding/python/Document_Grounding_Vector_API.ipynb)

<br/>
#### Guidelines to Setup Data Sources:

- SAP Document Management Service: [Connect DMS with Document Grounding](/docs/technical-view/ai-services/document-grounding-dms)
- SharePoint: [Connect SharePoint with Document Grounding](/docs/technical-view/ai-services/document-grounding-sharepoint)
- SAP Work Zone: [Connect SAP Work Zone with Document Grounding](/docs/technical-view/ai-services/document-grounding-workzone)
- SFTP file server: [Connect SFTP Server with Document Grounding](/docs/technical-view/ai-services/document-grounding-sftp)
...
<ul className="button-grid">
  <IconLinkButton href="/docs/technical-view/generative-ai/rag/vector-rag-embadding" text="Vector-based RAG - Embedding" />
