...
<div className="section-with-background blue">
  ## Implementation
  Agentic workflows can be achieved by orchestrating foundation models with tools, memory, and planning capabilities. Here you find how to build agentic AI systems on SAP BTP to implement a use-case that includes agentic workflows as an AI functional capability.

### Related Best Practices

<ul className="button-grid">
  <IconLinkButton href="/docs/technical-view/agentic-ai" text="Agentic AI" />
</ul>
